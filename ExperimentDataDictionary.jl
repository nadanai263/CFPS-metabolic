...
function interpolate_experimental_data(raw_time_vector, raw_data_vector, time_vector)
  return LinearInterpolation(raw_time_vector, raw_data_vector)(time_vector)
end
...
glucose_measurement.interpolated_measurement_array = interpolate_experimental_data(glucose_measurement.raw_measurement_array[:,1], glucose_measurement.raw_measurement_array[:,2],TSIM);
...
cat_measurement.interpolated_measurement_array = interpolate_experimental_data(cat_measurement.raw_measurement_array[:,1], cat_measurement.raw_measurement_array[:,2],TSIM);
...
atp_measurement.interpolated_measurement_array = interpolate_experimental_data(atp_measurement.raw_measurement_array[:,1], atp_measurement.raw_measurement_array[:,2],TSIM);
...
adp_measurement.interpolated_measurement_array = interpolate_experimental_data(adp_measurement.raw_measurement_array[:,1], adp_measurement.raw_measurement_array[:,2],TSIM);
...
amp_measurement.interpolated_measurement_array = interpolate_experimental_data(amp_measurement.raw_measurement_array[:,1], amp_measurement.raw_measurement_array[:,2],TSIM);
...
ctp_measurement.interpolated_measurement_array = interpolate_experimental_data(ctp_measurement.raw_measurement_array[:,1], ctp_measurement.raw_measurement_array[:,2],TSIM);
...
cdp_measurement.interpolated_measurement_array = interpolate_experimental_data(cdp_measurement.raw_measurement_array[:,1], cdp_measurement.raw_measurement_array[:,2],TSIM);
...
cmp_measurement.interpolated_measurement_array = interpolate_experimental_data(cmp_measurement.raw_measurement_array[:,1], cmp_measurement.raw_measurement_array[:,2],TSIM);
...
gtp_measurement.interpolated_measurement_array = interpolate_experimental_data(gtp_measurement.raw_measurement_array[:,1], gtp_measurement.raw_measurement_array[:,2],TSIM);
...
gdp_measurement.interpolated_measurement_array = interpolate_experimental_data(gdp_measurement.raw_measurement_array[:,1], gdp_measurement.raw_measurement_array[:,2],TSIM);
...
gmp_measurement.interpolated_measurement_array = interpolate_experimental_data(gmp_measurement.raw_measurement_array[:,1], gmp_measurement.raw_measurement_array[:,2],TSIM);
...
utp_measurement.interpolated_measurement_array = interpolate_experimental_data(utp_measurement.raw_measurement_array[:,1], utp_measurement.raw_measurement_array[:,2],TSIM);
...
udp_measurement.interpolated_measurement_array = interpolate_experimental_data(udp_measurement.raw_measurement_array[:,1], udp_measurement.raw_measurement_array[:,2],TSIM);
...
ump_measurement.interpolated_measurement_array = interpolate_experimental_data(ump_measurement.raw_measurement_array[:,1], ump_measurement.raw_measurement_array[:,2],TSIM);
...
lactate_measurement.interpolated_measurement_array = interpolate_experimental_data(lactate_measurement.raw_measurement_array[:,1], lactate_measurement.raw_measurement_array[:,2],TSIM);
...
acetate_measurement.interpolated_measurement_array = interpolate_experimental_data(acetate_measurement.raw_measurement_array[:,1], acetate_measurement.raw_measurement_array[:,2],TSIM);
...
pyr_measurement.interpolated_measurement_array = interpolate_experimental_data(pyr_measurement.raw_measurement_array[:,1], pyr_measurement.raw_measurement_array[:,2],TSIM);
...
succinate_measurement.interpolated_measurement_array = interpolate_experimental_data(succinate_measurement.raw_measurement_array[:,1], succinate_measurement.raw_measurement_array[:,2],TSIM);
...
malate_measurement.interpolated_measurement_array = interpolate_experimental_data(malate_measurement.raw_measurement_array[:,1], malate_measurement.raw_measurement_array[:,2],TSIM);
...
asp_measurement.interpolated_measurement_array = interpolate_experimental_data(asp_measurement.raw_measurement_array[:,1], asp_measurement.raw_measurement_array[:,2],TSIM);
...
gly_measurement.interpolated_measurement_array = interpolate_experimental_data(gly_measurement.raw_measurement_array[:,1], gly_measurement.raw_measurement_array[:,2],TSIM);
...
ile_measurement.interpolated_measurement_array = interpolate_experimental_data(ile_measurement.raw_measurement_array[:,1], ile_measurement.raw_measurement_array[:,2],TSIM);
...
asn_measurement.interpolated_measurement_array = interpolate_experimental_data(asn_measurement.raw_measurement_array[:,1], asn_measurement.raw_measurement_array[:,2],TSIM);
...
cys_measurement.interpolated_measurement_array = interpolate_experimental_data(cys_measurement.raw_measurement_array[:,1], cys_measurement.raw_measurement_array[:,2],TSIM);
...
lys_measurement.interpolated_measurement_array = interpolate_experimental_data(lys_measurement.raw_measurement_array[:,1], lys_measurement.raw_measurement_array[:,2],TSIM);
...
his_measurement.interpolated_measurement_array = interpolate_experimental_data(his_measurement.raw_measurement_array[:,1], his_measurement.raw_measurement_array[:,2],TSIM);
...
ala_measurement.interpolated_measurement_array = interpolate_experimental_data(ala_measurement.raw_measurement_array[:,1], ala_measurement.raw_measurement_array[:,2],TSIM);
...
gln_measurement.interpolated_measurement_array = interpolate_experimental_data(gln_measurement.raw_measurement_array[:,1], gln_measurement.raw_measurement_array[:,2],TSIM);
...
phe_measurement.interpolated_measurement_array = interpolate_experimental_data(phe_measurement.raw_measurement_array[:,1], phe_measurement.raw_measurement_array[:,2],TSIM);
...
pro_measurement.interpolated_measurement_array = interpolate_experimental_data(pro_measurement.raw_measurement_array[:,1], pro_measurement.raw_measurement_array[:,2],TSIM);
...
ser_measurement.interpolated_measurement_array = interpolate_experimental_data(ser_measurement.raw_measurement_array[:,1], ser_measurement.raw_measurement_array[:,2],TSIM);
...
thr_measurement.interpolated_measurement_array = interpolate_experimental_data(thr_measurement.raw_measurement_array[:,1], thr_measurement.raw_measurement_array[:,2],TSIM);
...
trp_measurement.interpolated_measurement_array = interpolate_experimental_data(trp_measurement.raw_measurement_array[:,1], trp_measurement.raw_measurement_array[:,2],TSIM);
...
tyr_measurement.interpolated_measurement_array = interpolate_experimental_data(tyr_measurement.raw_measurement_array[:,1], tyr_measurement.raw_measurement_array[:,2],TSIM);
...
val_measurement.interpolated_measurement_array = interpolate_experimental_data(val_measurement.raw_measurement_array[:,1], val_measurement.raw_measurement_array[:,2],TSIM);
...
met_measurement.interpolated_measurement_array = interpolate_experimental_data(met_measurement.raw_measurement_array[:,1], met_measurement.raw_measurement_array[:,2],TSIM);
...
leu_measurement.interpolated_measurement_array = interpolate_experimental_data(leu_measurement.raw_measurement_array[:,1], leu_measurement.raw_measurement_array[:,2],TSIM);
